try:
    ...
    from pyorganoid import Organoid, SpikingNeuronOrganoid, TFModel, Environment, Scheduler
    ...
    def custom_input_data_func(neuron):
    ...
    for i, neuron in enumerate(organoid.get_cells()):
        plt.plot(neuron.get_history(), label=f'Neuron {i}')
    ...
    Synchronization
    ----------------
        The neurons appear to be synchronized, as the membrane potentials rise and fall together. 
        This suggests that the input from the machine learning model affects the neurons in a uniform manner.
    ...
    ---------------------
        ...
        the neurons are receiving inputs that drive synchronized spiking patterns.
    """
